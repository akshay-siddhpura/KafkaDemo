...
public class TwitterProducerIdempotentHighThroughput {
    Logger log = LoggerFactory.getLogger(TwitterProducerIdempotentHighThroughput.class.getName());
    String consumerKey = "";
    String consumerSecret = "";
    String token = "";
    String secret = "";
    List<String> terms = Lists.newArrayList("bitcoin","china");

    public TwitterProducerIdempotentHighThroughput() {
    }
    ...
    public static void main(String[] args) {
        new TwitterProducerIdempotentHighThroughput().run();
    }
}
